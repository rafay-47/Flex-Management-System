            ...
            <AlternatingRowStyle BackColor="#d7edfd" />  
                 <HeaderStyle BackColor="#0066ff" ForeColor="White" />
                         <Columns>
                             ...
                             <asp:TemplateField HeaderText="Evaluation Type" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                 <ItemTemplate>
                                     
                                     <asp:Label ID="date" runat="server" Text='<%# Bind("evaluationtype") %>'></asp:Label>

                                 </ItemTemplate>
                             </asp:TemplateField>

                              <asp:TemplateField HeaderText="Marks" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                 <ItemTemplate>
                                     
                                     <asp:Label ID="status" runat="server" Text='<%# Bind("score") %>'></asp:Label>
